...
hsim    = uicontrol('Style','pushbutton',...
             'Parent',envS,...
             'String','Simulate','Position',[25,25,exLen,exHeight],...
             'Callback',@simbutton_Callback); 
         
hiter    = uicontrol('Style','edit',...
             'Parent',envS,...
             'String','Simulate','Position',[75,150,50,25],...
             'Callback',@iter_button_Callback,...
             'UserData',20,...
             'Tag','iterations_edit',...
             'String','20'); 
...
function simbutton_Callback(hObject,eventdata) 
    ...
    hiter = findobj('Tag','iterations_edit');
    iterations = hiter.UserData;
    

    simulate(environment,envGraph,agentPos,targetPos,radOfView, iterations)
    disp('SIMULATE');
...
function iter_button_Callback(hObject, eventdata)
